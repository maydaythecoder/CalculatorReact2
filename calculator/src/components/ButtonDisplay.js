        ...
        return(
            <div className="button">
               <span className="buttonContainer">
                 ...
                 <button name=")" onClick={e => this.props.onClick(e.target.name)}>)</button>
                 <button className="clearAll" name="CE" onClick={e => this.props.onClick(e.target.name)}>CE</button>
                 <button className="deleteOne" name="C" onClick={e => this.props.onClick(e.target.name)}>C</button>
                 <br/>
